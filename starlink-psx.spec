...
PSX to biblioteka funkcji fortranowych pozwalająca programistom
korzystać z funkcjonalności dostarczanej przez biblioteki POSIX i
X/OPEN. Użycie tej biblioteki umożliwia programistom korzystanie z
możliwości systemu operacyjnego w sposób niezależny od maszyny.
...
Pliki nagłówkowe biblioteki PSX.
